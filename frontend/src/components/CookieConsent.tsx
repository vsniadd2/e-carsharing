...
const COOKIE_CONSENT_KEY = 'ecoride_cookie_consent'

function CookieSvg() {
  return (
    <svg className="cookie-svg" xmlSpace="preserve" viewBox="0 0 122.88 122.25" aria-hidden>
      <g>
...
export default function CookieConsent() {
  ...
  useEffect(() => {
    ...
    if (saved !== 'accept' && saved !== 'decline') setVisible(true)
  }, [])
    ...
    <div className="fixed bottom-6 right-6 z-[9999]" role="dialog" aria-label="Согласие на cookie">
      <div className="cookie-consent-card">
        ...
        <p className="cookie-consent-description">
          Мы используем cookie, чтобы обеспечить лучший опыт на нашем сайте.{' '}
          <br />
        ...
        <div className="cookie-consent-buttons">
          ...
          <button type="button" className="cookie-consent-decline" onClick={decline}>
            Отклонить
          </button>
        </div>
      </div>
